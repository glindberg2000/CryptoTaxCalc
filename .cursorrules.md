# CryptoTaxCalc Development Rules
...
#### Memory Bank Creation (NEW DEVELOPERS)
**IMPORTANT**: This repository does NOT include a `cline_docs/` folder. Each developer must create their own:

1. **Read Project Context**: Start with `PRDs/CryptoTaxApp.md` and this file
2. **Create cline_docs/**: Make your own Memory Bank folder locally
3. **Build Context**: Create all required Memory Bank files based on your understanding
4. **Keep Private**: Never commit your `cline_docs/` folder to git
...
### Current Status
- **Discord Bot**: CryptoTaxManager#7931 (fully functional)
- **Server**: CryptoTax (ID: 1395578178973597799)
- **Primary Channels**: #general, #onboarding
- **Integration**: Working via MCP in Cursor IDE

### Discord Usage
- For all Discord interactions, use the `mcp_discord-manager_*` tools
...
### Project Structure
```
CryptoTaxCalc/                    # Repository folder name
...
└── cline_docs/                 # Memory Bank (CREATE YOUR OWN - not in git)
